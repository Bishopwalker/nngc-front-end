...
import PURPLE from '/purpleHouseMonster.png'
import OLD from '/olelady.png'
import MONSTER from'/furMonter3d.png'
import TRAILER3 from '/YarnCleanup1.png'
import TRAILER2 from '/NNGC-Plate.png'
