   ...
   // const processedEventTypes = new Set();
    ...
    function handleSse() {
      // Set to keep track of processed event data
        let eventSource = new EventSource('https://api.northernneckgarbage.com/sse/subscribe');
            ...
            eventSource.onerror = function (error) {
                ...
                eventSource.close();
                    ...
                    setTimeout(() => {
                        ...
                        eventSource = new EventSource('https://api.northernneckgarbage.com/sse/subscribe');
...
// Call this function when your component mounts
    ...
    const fetchAppointments = async () => {
        try {
            const response = await axios.get("https://api.northernneckgarbage.com/api/appointments/all");
    ...
    const submitAppointment = async () => {
        try {
            ...
            const apiEndpoint = "https://api.northernneckgarbage.com/api/appointments/create-appointment"; // Make sure this matches with your Postman endpoint
